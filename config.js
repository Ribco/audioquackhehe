...
module.exports = {
    ...
    bot: {
        ...
        maxQueueSize: 100,
        maxPlaylistSize: 50,
        status: process.env.STATUS || '🎵 AudioQuack | Quack your Music.',
        embedColor: process.env.EMBED_COLOR || '#FF6B6B',
        supportServer: process.env.SUPPORT_SERVER || 'https://discord.gg/SsWmreyuqw',
        website: process.env.WEBSITE || 'https://audioquack.bot.nu',
